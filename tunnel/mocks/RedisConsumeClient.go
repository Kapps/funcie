...
func (_m *RedisConsumeClient) Subscribe(ctx context.Context, channels ...string) tunnel.RedisPubSub {
	...
	var r0 tunnel.RedisPubSub
	if rf, ok := ret.Get(0).(func(context.Context, ...string) tunnel.RedisPubSub); ok {
		r0 = rf(ctx, channels...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(tunnel.RedisPubSub)
		}
	}
...
func (_c *RedisConsumeClient_Subscribe_Call) Return(_a0 tunnel.RedisPubSub) *RedisConsumeClient_Subscribe_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RedisConsumeClient_Subscribe_Call) RunAndReturn(run func(context.Context, ...string) tunnel.RedisPubSub) *RedisConsumeClient_Subscribe_Call {
	_c.Call.Return(run)
	return _c
}
