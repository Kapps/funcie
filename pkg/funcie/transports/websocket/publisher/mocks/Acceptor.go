...
func (_m *Acceptor) Accept(ctx context.Context, rw http.ResponseWriter, req *http.Request) (websocket.Connection, error) {
	ret := _m.Called(ctx, rw, req)

	var r0 websocket.Connection
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, http.ResponseWriter, *http.Request) (websocket.Connection, error)); ok {
		return rf(ctx, rw, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, http.ResponseWriter, *http.Request) websocket.Connection); ok {
		r0 = rf(ctx, rw, req)
	} else {
		if ret.Get(0) != nil {
...
func (_c *Acceptor_Accept_Call) Return(_a0 websocket.Connection, _a1 error) *Acceptor_Accept_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Acceptor_Accept_Call) RunAndReturn(run func(context.Context, http.ResponseWriter, *http.Request) (websocket.Connection, error)) *Acceptor_Accept_Call {
	_c.Call.Return(run)
	return _c
}
