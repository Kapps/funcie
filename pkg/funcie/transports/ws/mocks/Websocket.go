...
func (_m *Websocket) Reader(ctx context.Context) (websocket.MessageType, io.Reader, error) {
	ret := _m.Called(ctx)

	var r0 websocket.MessageType
	var r1 io.Reader
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context) (websocket.MessageType, io.Reader, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) websocket.MessageType); ok {
		r0 = rf(ctx)
...
// Websocket_Reader_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Reader'
type Websocket_Reader_Call struct {
	*mock.Call
}

// Reader is a helper method to define mock.On call
//   - ctx context.Context
func (_e *Websocket_Expecter) Reader(ctx interface{}) *Websocket_Reader_Call {
	return &Websocket_Reader_Call{Call: _e.mock.On("Reader", ctx)}
}

func (_c *Websocket_Reader_Call) Run(run func(ctx context.Context)) *Websocket_Reader_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *Websocket_Reader_Call) Return(_a0 websocket.MessageType, _a1 io.Reader, _a2 error) *Websocket_Reader_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *Websocket_Reader_Call) RunAndReturn(run func(context.Context) (websocket.MessageType, io.Reader, error)) *Websocket_Reader_Call {
	_c.Call.Return(run)
	return _c
}
...
// Writer provides a mock function with given fields: ctx, typ
func (_m *Websocket) Writer(ctx context.Context, typ websocket.MessageType) (io.WriteCloser, error) {
	ret := _m.Called(ctx, typ)

	var r0 io.WriteCloser
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, websocket.MessageType) (io.WriteCloser, error)); ok {
		return rf(ctx, typ)
	}
	if rf, ok := ret.Get(0).(func(context.Context, websocket.MessageType) io.WriteCloser); ok {
		r0 = rf(ctx, typ)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, websocket.MessageType) error); ok {
		r1 = rf(ctx, typ)
	} else {
		r1 = ret.Error(1)
	}
...
// Websocket_Writer_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Writer'
type Websocket_Writer_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - typ websocket.MessageType
func (_e *Websocket_Expecter) Writer(ctx interface{}, typ interface{}) *Websocket_Writer_Call {
	return &Websocket_Writer_Call{Call: _e.mock.On("Writer", ctx, typ)}
}

func (_c *Websocket_Writer_Call) Run(run func(ctx context.Context, typ websocket.MessageType)) *Websocket_Writer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(websocket.MessageType))
	})
	return _c
}

func (_c *Websocket_Writer_Call) Return(_a0 io.WriteCloser, _a1 error) *Websocket_Writer_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Websocket_Writer_Call) RunAndReturn(run func(context.Context, websocket.MessageType) (io.WriteCloser, error)) *Websocket_Writer_Call {
	_c.Call.Return(run)
	return _c
}
